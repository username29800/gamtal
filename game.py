...
if rc==1:
  ...
  pg.mouse.set_visible(False)
  tr=0
  # assign rect to character íëµ†ëì …ìì” ìë¼± ìê¶—åª›ê³¹ì‚Ž ìê¹®ìê½¦
...
while running:
  ...
  if tr<4:
    ...
    if pcu==pcr0:
      ...
      piu=pci0
      tr=0
  # add code for the first stage //1ìë’ªíë€’ìì” ï§ž€ è‚„ë¶¾ë±¶ ç•°ë¶½°€
  # background è«›ê³Œê¼ draw
  screen.blit(bg,(0,0))  
  ...
  # spawn obstacle ìì˜£ìë¸·è‡¾¼(è«›â‘ºë¹è‡¾¼) ìê¹®ìê½¦
  if x_or_y!=0:
